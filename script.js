const changelogData = {
    ...
    "25/1/2025":[
        ...
        { "category": "Added", "description": "Restartbot command (Jay)" },
        { "category": "Added", "description": "Nicer Styling and Month Groups to changelog web (Facos98)" },
        { "category": "Added", "description": "New LAS Command Skoda (Ross)" },
        { "category": "Added", "description": "New Volvo V90 (Ross)" },
        { "category": "Added", "description": "Cupra Leon (Ross)" },
        { "category": "Fixed", "description": "G31 Light blue lights (Ross)" },
        { "category": "Added", "description": "New Matrix flash pattern (Ross)" },
        { "category": "Fixed", "description": "X5 ELS pattern (Ross)" },
        { "category": "Added", "description": "A6 Light pattern (Ross)" },
        { "category": "Added", "description": "New Car 🤭 (Ross)" },
        { "category": "Added", "description": "New S60 (Ross)" },
        { "category": "Added", "description": "New G31 (Ross)" },
        { "category": "Removed", "description": "zELS (Ross)" },
        { "category": "Added", "description": "oELS (Ross)" },
        { "category": "Removed", "description": "Legion Christmas YMAP (Ross)" },
        { "category": "Added", "description": "New LAS Command Skoda (Ross)" },
        { "category": "Added", "description": "New LAS V90 (RRV) (Ross)" },
        { "category": "Added", "description": "New RTPC G20 Better Skin (Ross)" },
        { "category": "Added", "description": "New RTPC Skoda SuperB marked (Ross)" },
        { "category": "Added", "description": "Map blips (Charlie)" },
        { "category": "Fixed", "description": "Spawn menu & Blip for South Central (Ross)" },
        { "category": "Added", "description": "New CoLP V90 (Ross)" },
        { "category": "Added", "description": "New XC90 (Ross)" },
        { "category": "Added", "description": "New custom X1 (MET/LAS) (Ross)" },
        { "category": "Added", "description": "New custom M5 (UM) (Ross)" },
        { "category": "Added", "description": "New marked M5 (Ross)" },
        { "category": "Updated", "description": "Founder Menu, the menu is now made using ox_lib (Jay)" },
        { "category": "Added", "description": "New Custom F11 😉 (Ross)" },
        { "category": "Added", "description": "Change-Team Menu (Including custom exports) (Jay)" },
        { "category": "Removed", "description": "CD Spawnselect (Jay)" },
        { "category": "Added", "description": "ox_lib (Jay)" },
        { "category": "Updated", "description": "F5 Menu, Changed from openspawnselect to changeteam (Jay)" },
        { "category": "Fixed", "description": "AI ID Card Styling (Jay)" },
        { "category": "Updated", "description": "EasyAdmin (Jay)" },
        { "category": "Added", "description": "Screenshot Basic (Jay)" },
        { "category": "Added", "description": "LAS Collision Report Form (Jay)" },
        { "category": "Added", "description": "LR Discovery UM (Ross)" },
        { "category": "Added", "description": "VW Golf (Ross)" }
    ],
